    ...
    <section id="sobre" className="py-24 sm:py-32 bg-paper">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="space-y-5 text-graphite text-[16.5px] leading-relaxed max-w-2xl">
              <p>
                ...
                <span className="text-ink font-medium">Italo Campos</span>, no
              ...
              <p>
                Hoje, a Lume conversa, consulta, calcula e entrega. Atende seus
                clientes, lê seus dados, sugere decisões. Trabalha 24 horas, 7
                dias por semana, sem pausa para o café — porque o seu negócio
                também não pausa.
              </p>
            </div>
          </div>
          ...
          {/* Coluna fatos */}
          <aside className="lg:col-span-5 lg:pl-8 lg:border-l border-bone">
